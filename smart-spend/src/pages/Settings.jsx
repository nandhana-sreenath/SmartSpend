...
//   <div className="d-flex gap-2">
//     <div className="flex-fill">
//       <label className="form-label" style={{ ...labelStyle, fontSize: '0.9rem' }}>Month</label>
//       <select
//         className="form-select"
//         style={{ ...inputStyle, opacity: isFrame1Editable ? 1 : 0.7 }}
//         value={month}
//         onChange={isFrame1Editable ? (e) => setMonth(e.target.value) : undefined}
//         disabled={!isFrame1Editable}
//       >
...
//     </div>
//     <div className="flex-fill">
//       <label className="form-label" style={{ ...labelStyle, fontSize: '0.9rem' }}>Year</label>
//       <select
//         className="form-select"
//         style={{ ...inputStyle, opacity: isFrame1Editable ? 1 : 0.7 }}
//         value={year}
//         onChange={isFrame1Editable ? (e) => setYear(e.target.value) : undefined}
//         disabled={!isFrame1Editable}
//       >
//         <option value="">Select Year</option>
//         {Array.from({ length: 50 }, (_, i) => {
//   const year = new Date().getFullYear() - 25 + i; // 25 years back, 25 forward
